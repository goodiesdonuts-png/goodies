            ...
            <div className="glass-card p-6 border-t-4 border-t-brand-500">
              ...
              <div className="glass-card p-6 border-l-4 border-brand-500 mt-6">
                ...
                <div className="flex w-full h-4 rounded-full overflow-hidden bg-slate-100 mb-4">
                  <div style={{ width: `${(unitCMV / (activeProfile.salePrice || 1)) * 100}%` }} className="bg-rose-400" title="Custo Unitário (Produção + Embalagem + Tempo)"></div>
                ...
                <div className="flex flex-wrap gap-4 text-xs font-medium text-slate-600">
                  <div className="flex items-center gap-1"><span className="w-3 h-3 rounded-full bg-rose-400"></span> Custo Unitário ({(unitCMV / (activeProfile.salePrice || 1) * 100).toFixed(1)}%)</div>
